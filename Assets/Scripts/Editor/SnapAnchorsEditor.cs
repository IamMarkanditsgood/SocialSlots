...
public class SnapAnchorsEditor : MonoBehaviour
{
    [MenuItem("GameObject/Snap Anchors/in this and it'i children", false, 0)]
    ...
    public static void StaticSnapAnchors(GameObject o)
    {
        ...
        if (o.transform.parent != null)
        {
            if (o.gameObject.tag != "IgnoreSnapAnchors")
            {
                ...
                {
                    Debug.LogError(o.name + " Doesn't have RectTransform. SnapAnchors must be used only with UI objects. Please select i objet with RectTransform. Returning function.");
                    return;
                }
